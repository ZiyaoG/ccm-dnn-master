function [output, state] = CDC_safe_explo(input, params, varargin)
%CDC_SAFE_EXPLO Function implementing an imported ONNX network.
%
...
%
% [OUTPUT] = CDC_safe_explo(INPUT, PARAMS)
%			- Evaluates the imported ONNX network CDC_SAFE_EXPLO with input(s)
%			INPUT and the imported network parameters in PARAMS. Returns
%			network output(s) in OUTPUT.
%
% [OUTPUT, STATE] = CDC_safe_explo(INPUT, PARAMS)
%			- Additionally returns state variables in STATE. When training,
%			use this form and set TRAINING to true.
%
% [__] = CDC_safe_explo(INPUT, PARAMS, 'NAME1', VAL1, 'NAME2', VAL2, ...)
...
% Gemm:
[A, B, C, alpha, beta, NumDims.x11] = prepareGemmArgs(Vars.input, Vars.w1_weight, Vars.w1_bias, Vars.Gemmalpha1001, Vars.Gemmbeta1002, 0, 1, NumDims.w1_bias);
Vars.x11 = alpha*B*A + beta*C;

% Relu:
Vars.x12 = relu(Vars.x11);
NumDims.x12 = NumDims.x11;

% Gemm:
[A, B, C, alpha, beta, NumDims.x13] = prepareGemmArgs(Vars.x12, Vars.w2_weight, Vars.w2_bias, Vars.Gemmalpha1003, Vars.Gemmbeta1004, 0, 1, NumDims.w2_bias);
...
% Gemm:
[A, B, C, alpha, beta, NumDims.x15] = prepareGemmArgs(Vars.x14, Vars.w3_weight, Vars.w3_bias, Vars.Gemmalpha1005, Vars.Gemmbeta1006, 0, 1, NumDims.w3_bias);
...
% Gemm:
[A, B, C, alpha, beta, NumDims.x17] = prepareGemmArgs(Vars.x16, Vars.w4_weight, Vars.w4_bias, Vars.Gemmalpha1007, Vars.Gemmbeta1008, 0, 1, NumDims.w4_bias);
...
% Gemm:
[A, B, C, alpha, beta, NumDims.output] = prepareGemmArgs(Vars.x18, Vars.w5_weight, Vars.w5_bias, Vars.Gemmalpha1009, Vars.Gemmbeta1010, 0, 1, NumDims.w5_bias);
...
% Function to validate inputs to CDC_safe_explo:
p = inputParser;
