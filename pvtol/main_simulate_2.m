...
save('states_06_106_dropping_1_10.mat','xTraj_trsp');
save('disturbance_06_106_dropping_1_10.mat','dist_trsp');
disp('finish')
...
jac(:,1) = vec((prd_dist(x_pt1(1:2:end,:))-prd_dist(x_pt1(2:2:end,:)))/(2*e));    
jac(:,2) = vec((prd_dist(x_pt2(1:2:end,:))-prd_dist(x_pt2(2:2:end,:)))/(2*e)); 
jac(:,3) = vec((prd_dist(x_pt3(1:2:end,:))-prd_dist(x_pt3(2:2:end,:)))/(2*e)); 
jac(:,4) = vec((prd_dist(x_pt4(1:2:end,:))-prd_dist(x_pt4(2:2:end,:)))/(2*e)); 
...
dist_force = [-0.8; -1]*(dist_intensity.*dist_force_max); %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% changed %%%%%%%%%%%%%%
