...
if use_distModel_in_planning_control == 0
    if controller.distEstScheme ~= 0
        controller.distEstScheme = 2;
    end
end
...
if sim_config.save_sim_rst == 1
    file_name = ['ACC/DECCM_no_learning_' num2str(sim_config.step_size*1000) 'ms_' num2str(delay) 's_delay'];
