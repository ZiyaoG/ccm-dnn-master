...
%% Task 3
load('sim_de_ccm_lam_0.8_w_dist_1_with_perfect_Adam__04_106_w_obs.mat');
...
%% Task 2
load('sim_de_ccm_lam_0.8_w_dist_1_with_perfect_Adam__100_210_w_obs.mat');
...
print('With perfect learning_DE.pdf', '-painters', '-dpdf', '-r150');
%% functions
