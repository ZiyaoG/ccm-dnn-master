...
%% Task 1
load('sim_de_ccm_lam_0.8_w_dist_1_100_210_w_obs.mat');
...
%% Task 2
load('sim_de_ccm_T_0.0001_lam_0.8_w_dist_1bound0.1_04_106_w_obs.mat');
...
print('With no learning_DE.pdf', '-painters', '-dpdf', '-r150');
%% functions
