...
hold on;
%% Task 1
load('simulation_results/sim_de_ccm_lam_0.8_w_dist_1_with_better_Adam__00_810_w_obs.mat');
...
%% Task 2
load('simulation_results/sim_de_ccm_T_0.0001_lam_0.8_w_dist_1_with_better_Adam_bound0.1_100_210_w_obs.mat');
...
print('With moderate learning.pdf', '-painters', '-dpdf', '-r150');
%% functions
